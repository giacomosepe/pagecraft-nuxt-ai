...
# Subdirectory AGENTS.md files load automatically — do not @import them here.
# For history and decisions: ~/Codex/_projects/pagecraft/changelog.md
...
Users work through Steps sequentially, use Codex AI to generate content, export to Word.
...
Tasks are scoped and routed by the PM before reaching Codex.
...
When writing or revising Linear issues, read `~/Codex/_skills/linear-issue-writer/SKILL.md` first.
